...
## NMDA synapse
AdEx_Synapse_g(s::AdEx_Synapse_NMDA, t::AdEx_Float, t_f::AdEx_Float, V::AdEx_Float) = s.g_c_NMDA * (1 - exp(-((t - t_f) / s.τ_rise))) * exp(-((t - t_f) / s.τ_decay)) * (1 + s.β * exp(-s.α * V) * s.Mg2p)^(-1) * Θ(t - t_f);

## GABA synapses
AdEx_Synapse_g(s::AdEx_Synapse_GABA_A, t::AdEx_Float, t_f::AdEx_Float, V::AdEx_Float) = s.g_c_GABA_A * (1 - exp(-((t - t_f) / s.τ_rise))) * (s.a * exp(-((t - t_f) / s.τ_fast))) * Θ(t - t_f);
AdEx_Synapse_g(s::AdEx_Synapse_GABA_B, t::AdEx_Float, t_f::AdEx_Float, V::AdEx_Float) = s.g_c_GABA_B * (1 - exp(-((t - t_f) / s.τ_rise))) * (s.a * exp(-((t - t_f) / s.τ_fast)) + (1 - s.a) * exp(-((t - t_f) / s.τ_slow))) * Θ(t - t_f);

## AMPA synapse
AdEx_Synapse_g(s::AdEx_Synapse_AMPA, t::AdEx_Float, t_f::AdEx_Float, V::AdEx_Float) = s.g_c_AMPA * exp(-((t - t_f) / s.τ)) * Θ(t - t_f);
